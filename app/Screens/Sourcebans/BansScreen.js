...
const BansScreen = () => {
    ...
    useEffect(() => {
        fetch('https://jaguarescsgo.com.br/api/v1/bans')
    ...
    return (
        <StyledContainer>
            <Tabbing />
            <Title>
                <Text style={Fonts.title}>Banimentos</Text>
            </Title>
            <AdMobBanner
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                ...
                                <DataTable.Row>
                                    <PlayerRow>
                                        <RankTouchable
                                            onPress={() => Linking.openURL('https://sb.jaguarescsgo.com.br/index.php?p=banlist&advSearch=' + item.authid + '&advType=steamid&Submit')}
                                        >
